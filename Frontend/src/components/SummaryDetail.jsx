                    ...
                    <div className="flex-1">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent break-words">
                                {selectedSummary?.fetchedMeetings?.title}
                            </h1>
                        ...
                        <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs sm:text-sm text-gray-400">
                            <div className="flex items-center gap-2">
                                ...
                                <span>{selectedSummary?.fetchedMeetings?.date}</span>
                            </div>
                            <div className="flex items-center gap-2 ">
                                <Users size={14} className="flex-shrink-0" />
                                <span>{selectedSummary?.fetchedMeetings?.participants} participants</span>
                            </div>
                            {/* <div className="flex items-center gap-2">
                ...
                <DetailSection
                    ...
                    content={
                        <p className="leading-relaxed text-sm md:text-base">
                            {selectedSummary.summaryText || "The Project Alpha kickoff meeting was held to align the team on the project goals, timelines, and responsibilities. Key discussions included the project scope, deliverables, and milestones."}
                        </p>
                    }
                />
                        ...
                        <div className="space-y-2 md:space-y-3">
                            {selectedSummary.actionItems?.map((item, i) => (
                                <div key={i} className="flex items-start gap-3">
                                    ...
                                    <span className="text-sm md:text-base">{item.task}</span>
                                </div>
                            )) || (
                                    <>
                                        <div className="flex items-start gap-3">
