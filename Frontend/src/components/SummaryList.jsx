...
export const SummaryList = ({
    ...
    const filteredSummaries = summaries.filter(summary => {
        const matchesSearch = summary.fetchedMeetings.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
                                    ...
                                    <CardContent className="p-3">
                                        ...
                                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[0.75rem] text-gray-400 mb-1">
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="truncate max-w-[80px]">{formatDate(summary.generatedAt)}</span>
                                            </div>
                                            {/* <div className="flex items-center gap-1">
